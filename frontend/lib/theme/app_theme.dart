...
class AppTheme {
  ...
  static ThemeData light() {
    ...
    final textTheme = base.textTheme.apply(
      ...
      displayLarge: const TextStyle(color: textPrimary, fontWeight: FontWeight.w800, letterSpacing: -1.2),
      displayMedium: const TextStyle(color: textPrimary, fontWeight: FontWeight.w800, letterSpacing: -0.8),
      headlineLarge: const TextStyle(color: textPrimary, fontWeight: FontWeight.w800, letterSpacing: -0.5),
      headlineMedium: const TextStyle(color: textPrimary, fontWeight: FontWeight.w800, letterSpacing: -0.35),
      headlineSmall: const TextStyle(color: textPrimary, fontWeight: FontWeight.w800),
      titleLarge: const TextStyle(color: textPrimary, fontWeight: FontWeight.w700, letterSpacing: -0.2),
      titleMedium: const TextStyle(color: textPrimary, fontWeight: FontWeight.w700),
      titleSmall: const TextStyle(color: textPrimary, fontWeight: FontWeight.w700),
      bodyLarge: const TextStyle(color: textPrimary, height: 1.35),
      bodyMedium: const TextStyle(color: textPrimary, height: 1.35),
      bodySmall: const TextStyle(color: textMuted, height: 1.35),
      labelLarge: const TextStyle(color: textPrimary, fontWeight: FontWeight.w700),
      labelMedium: const TextStyle(color: textPrimary, fontWeight: FontWeight.w700),
      labelSmall: const TextStyle(color: textMuted, fontWeight: FontWeight.w600),
    );
